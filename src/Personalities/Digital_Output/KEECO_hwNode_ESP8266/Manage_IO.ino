...
char sensor_topic[80] = "/digital_output_status";
...
void initIO() {
  ...
  */
  espConfig.mqttSubTopic[0] = "/set_digital_output";
...
void IOprocessInLoop() {
  ...
  */
  ...
  if (digitalValue != digitalValuePrev) {
    digitalValuePrev = digitalValue;
#ifdef DEBUG
    Serial.print("Digital input changed: ");
    Serial.println(digitalValue);
#endif
    itoa(digitalValue, sensor_string, 10);
